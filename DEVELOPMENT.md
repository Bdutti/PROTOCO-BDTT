...
```bash
git remote add encore encore://ppl-premium-tracker-2t9i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ppl-premium-tracker-2t9i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ppl-premium-tracker-2t9i/settings/integrations/github)
